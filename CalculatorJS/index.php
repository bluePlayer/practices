...
<html>
    ...
    <body class="body">
        ...
        <table class="table">
            <tr>
                <td colspan="5"><input type="text" value="0" class="textField" readonly id="digitsField"/></td>
            </tr>
            <tr>
                <td colspan="5"><input type="text" value="" class="textField" readonly id="memoryLabel"/></td>
            </tr>
            <tr>
                <td colspan="5"><textarea class="textField" id="operationField" readonly></textarea></td>
            </tr>
            <tr>
