...
(function($) {
    ...
    var Tooltip = function(element, options) {
        this.type = this.options = this.enabled = this.timeout = this.hoverState = this.$measure = this.$element = null;
    ...
    Tooltip.prototype.init = function(type, element, options) {
        ...
        this.options = this.options.selector ? (this.options = $.extend({}, this.options, {
            trigger : 'manual',
            selector : ''
        })) : this.fixTitle();
    };
    ...
    Tooltip.prototype.getDelegateOptions = function() {
        ...
        options = this.options && $.each(this.options, function(key, value) {
    ...
    Tooltip.prototype.getAutoPlace = function($tip, placement, pos, actualWidth, actualHeight) {
        ...
        placement = placement === 'bottom' && pos.top + pos.height + actualHeight - docScroll > parentHeight ? 'top' : placement === 'top' && pos.top - docScroll - actualHeight < 0 ? 'bottom' : placement === 'right' && pos.left + actualWidth > parentWidth ? 'left' : placement === 'left' && pos.left - actualWidth < parentLeft ? 'right' : placement;
    ...
    Tooltip.prototype.getCalculatedOffset = function(placement, pos, actualWidth, actualHeight, follow) {
        ...
        if ( typeof follow !== 'undefined') {
            ...
            return placement === 'bottom' ? {
                top : follow.pageY + this.options.mouseOffset,
                left : follow.pageX - (actualWidth / 2)
            } : placement === 'top' ? {
                top : follow.pageY - actualHeight - this.options.mouseOffset,
                left : follow.pageX - (actualWidth / 2)
            } : placement === 'left' ? {
                top : follow.pageY - this.options.mouseOffset,
                left : follow.pageX - (actualWidth + this.options.mouseOffset)
            } : {
                top : follow.pageY - this.options.mouseOffset,
                left : follow.pageX + this.options.mouseOffset
            };
        }
