        ...
        run: function () {
            ...
            d3.csv(csvUrl, function(error, data) {
                ...
                link = g.selectAll(".link")
                    ...
                    .attr("class", "link")
                    .attr("d", function(d) {
                        return "M" + self.project(d.x, d.y) + "C" + 
                            self.project(d.x, (d.y + d.parent.y) / 2) + " " + 
                ...
                node.append("a")
                    .attr("xlink:href", function (d) {
                        return (d.data.url || "http://bl.ocks.org/mbostock");
                    })
                    .attr("target", "_blank")
                    .append("text")
                    .attr("dy", ".31em")
                    .attr("x", function(d) {
                        console.dir(d);
                        return ((d.x < 180 || d.children !== undefined) ? 6 : -6); 
                    })
                    .style("text-anchor", function(d) { 
                        return ((d.x < 180 || d.children !== undefined) ? "start" : "end"); 
                    })
                    .attr("transform", function(d) { 
