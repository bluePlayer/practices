...
var factoryFunc = function(QUnit, iframe) {
    'use strict';
    var hasBound,
        modules = 1,
    ...
    function appendSuitesToHeader(suites) {
        ...
        for ( i = 0,
        suitesLen = suites.length; i < suitesLen; i += 1) {
            suite = suites[i];
