...
module.exports = function(config) {
    ...
    config.set({
        ...
        files: [
            ...
            'Testing/unit_tests/js/tests/InnerSlotMatrixUtilityTests/*.js'
        ],
        ...
        exclude: [
            '**/*.html',
            'Testing/unit_tests/js/underscore.min.js',
            ...
            'Testing/unit_tests/js/tests/UnderscoreTests.js'
        ],
        ...
        client: {
            ...
            qunit: {
                showUI: true,
                testTimeout: 5000,
                filter: 'removeVertBafflesBeamsAndHangers(partsArray, maxNumOfBeams)'
            }
        },
