...
window.FrnConstr = window.FrnConstr || (function (frnConstrWindowObject, phaser, renderingMode, frnConstr, jq) {'use strict';
    var
        ...
        /**
         * game is private variable that holds the game object and it is accessible trough FrnConstr.gameObject from outside.
         * @property game
         * @private
         * @type Phaser.Game
         * @default new Phaser.Game(STAGE_WIDTH, STAGE_HEIGHT, Phaser.AUTO, HTML_CONTAINER)
         */
        game = new phaser.Game(STAGE_WIDTH, STAGE_HEIGHT, renderingMode, HTML_CONTAINER);
    ...
    return {
        ...
        /**
         * createFrnConstrPreloader() sets up all internal properties in preloader object and returns its value.
         * @method createFrnConstrPreloader
         * @default {
         *      loadingObjects: null,
         *      loadingLabel: null,
         ...
         * @return {Object}
         */
        createFrnConstrPreloader: function () {
            var preloader = {
                    ready: false,
                    loadingTween: null,
                    loadingLabel: null,
            ...
            preloader.loadingLabel = game.add.sprite(graphicsConst.LOADING_LABEL_X_POS,
                                                        graphicsConst.LOADING_LABEL_Y_POS,
                                                        thisObject.ImageAssetKeys.OTHER_GUI_ASSETS_ATLAS,
                                                        LOADING_LABEL_IMG_KEY);
            ...
            preloader.preloaderBottom.beginFill(graphicsConst.Colors.MATTERHORN, graphicsConst.ALPHA_100_PERCENT);
            preloader.preloaderBottom.drawRect(graphicsConst.PRELOADER_BOTTOM_START_XY,
                                                graphicsConst.PRELOADER_BOTTOM_START_XY,
                                                graphicsConst.PRELOADER_BOTTOM_WIDTH,
                                                graphicsConst.PRELOADER_BOTTOM_HEIGHT,
                                                "preloaderBottom");
            ...
            preloader.preloaderTop.beginFill(graphicsConst.Colors.DARK_GRAY, graphicsConst.ALPHA_100_PERCENT);
            preloader.preloaderTop.drawRect(graphicsConst.PRELOADER_TOP_START_XY,
                                            graphicsConst.PRELOADER_TOP_START_XY,
                                            graphicsConst.PRELOADER_TOP_WIDTH,
                                            graphicsConst.PRELOADER_TOP_HEIGHT,
                                            "preloaderTop");
        ...
        generateWardrobe: function () {
            frnConstrDataObject = thisObject.setDataObject(thisObject.getFormDataArray());
            game.state.start(thisObject.EnteriorScreen.KEY);
        },
        ...
        init: function (configObject) {
            ...
            if (renderingMode !== phaser.HEADLESS && renderingMode !== undefined && renderingMode !== null) {
